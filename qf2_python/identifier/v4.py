...
def get_board_information(r, verbose=False):
    ...
    bootloader_crc32 = str()
    x = r[55:59]
    x.reverse()
    for i in x: bootloader_crc32 += '{:02x}'.format(i)
    if bootloader_crc32 == 'ffffffff':
        bootloader_crc32 = 'NOT SET'
    ...
    x = r[107:111]
    x.reverse()
    for i in x: runtime_crc32 += '{:02x}'.format(i)
    if runtime_crc32 == 'ffffffff':
        runtime_crc32 = 'NOT SET'
    ...
    x = r[159:163]
    x.reverse()
    for i in x: kintex_crc32 += '{:02x}'.format(i)
    if kintex_crc32 == 'ffffffff':
        kintex_crc32 = 'NOT SET'
    ...
    ret = {
        ...
        'Bootloader CRC32' : bootloader_crc32,
        'Runtime CRC32' : runtime_crc32,
        'Kintex CRC32' : kintex_crc32,
