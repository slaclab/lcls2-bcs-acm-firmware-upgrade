...
def test_mfc_full_with_loopback():
    ...
    for i in range(0, 12):
        ...
        print '{0:024b}'.format(1 << i), '{0:024b}'.format(x.get_full_mfc_p()),
        if ( x.get_full_mfc_p() & (1 << (i + 12)) == 0 ):
            print ' ******** ',
            num_errors += 1
        print
        x.set_full_mfc_p(0, 1 << i)
        print '{0:024b}'.format((1 << i) ^ 0xFFFFFF), '{0:024b}'.format(x.get_full_mfc_p()),
        if ( x.get_full_mfc_p() & (1 << (i + 12)) != 0 ):
            print ' ******** ',
            num_errors += 1
        print
    ...
    for i in range(0, 12):
        ...
        print '{0:024b}'.format(1 << i), '{0:024b}'.format(x.get_full_mfc_n()),
        if ( x.get_full_mfc_n() & (1 << (i + 12)) == 0 ):
            print ' ******** ',
            num_errors += 1
        print
        x.set_full_mfc_n(0, 1 << i)
        print '{0:024b}'.format((1 << i) ^ 0xFFFFFF), '{0:024b}'.format(x.get_full_mfc_n()),
        if ( x.get_full_mfc_n() & (1 << (i + 12)) != 0 ):
            print ' ******** ',
            num_errors += 1
        print
...
def test_mfc_aux_with_loopback():
    ...
    for i in range(0, 8):
        ...
        print '{0:020b}'.format(1 << i), '{0:020b}'.format(x.get_aux_mfc_p()),
        if ( x.get_aux_mfc_p() & (1 << (i + 12)) == 0 ):
            print ' ******** ',
            num_errors += 1
        print
        x.set_aux_mfc_p(0, 1 << i)
        print '{0:020b}'.format((1 << i) ^ 0xFFFFF), '{0:020b}'.format(x.get_aux_mfc_p()),
        if ( x.get_aux_mfc_p() & (1 << (i + 12)) != 0 ):
            print ' ******** ',
            num_errors += 1
        print
    ...
    for i in range(0, 8):
        ...
        print '{0:020b}'.format(1 << i), '{0:020b}'.format(x.get_aux_mfc_n()),
        if ( x.get_aux_mfc_n() & (1 << (i + 12)) == 0 ):
            print ' ******** ',
            num_errors += 1
        print
        x.set_aux_mfc_n(0, 1 << i)
        print '{0:020b}'.format((1 << i) ^ 0xFFFFF), '{0:020b}'.format(x.get_aux_mfc_n()),
        if ( x.get_aux_mfc_n() & (1 << (i + 12)) != 0 ):
            print ' ******** ',
            num_errors += 1
        print
